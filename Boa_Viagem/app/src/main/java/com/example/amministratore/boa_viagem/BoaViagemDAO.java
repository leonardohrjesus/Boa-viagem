...
public class BoaViagemDAO {
    ...
    public List<DatabaseHelper.Gasto> listarGastos(Viagem viagem){
        ...
        Cursor cursor = getDb().query(DatabaseHelper.Gasto.TABELA,
                ...
                null, null, null);
        List<DatabaseHelper.Gasto> gastos = new ArrayList<>();
        while(cursor.moveToNext()){
            DatabaseHelper.Gasto gasto = criarGasto(cursor);
            gastos.add(gasto);
        }
        cursor.close();
        return gastos;
    ...
    public DatabaseHelper.Gasto buscarGastoPorId(Integer id){
        Cursor cursor = getDb().query(DatabaseHelper.Gasto.TABELA,
                DatabaseHelper.Gasto.COLUNAS,
    ...
    private DatabaseHelper.Gasto criarGasto(Cursor cursor) {
        DatabaseHelper.Gasto gasto = new DatabaseHelper.Gasto(
                cursor.getLong(cursor.getColumnIndex(
                        DatabaseHelper.Gasto._ID)),
